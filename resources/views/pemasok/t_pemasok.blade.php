...
@section('content')
@section('judul', 'Laravel | Tambah Pemasok')


<form action="/pemasok/save_pemasok" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="alert alert-success mt-2" role="alert">
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2 class="my-3">Daftar Pemasok</h2>
                    <hr>
                    ...
                    <div class="form-group row">
                        <label for="namapimpinan" class=" col-2 col-form-label">Pimpinan</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group row">
                        <label for="namaadmin" class=" col-2 col-form-label">Admin</label>
                        <div class="col-sm-4">
